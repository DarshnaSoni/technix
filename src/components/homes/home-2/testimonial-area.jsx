...
const testimonial_data = [
	{
		...
		description: (
			<>
				“It is wanting to come here and afterward Our office is something We
				consider it the little we are pleased with. magnet; difficult to leave
				it. <br /> Our office is additionally a big name.”
			</>
		),
	},
	{
		...
		description: (
			<>
				“A big name Our office is additionally . Our office is something <br />{" "}
				we are pleased with. We consider it the little magnet; <br />
				it is wanting to come here and afterward difficult to leave it.”
			</>
		),
	},
	{
		...
		description: (
			<>
				“Our office is something we are pleased with. We consider it the little{" "}
				<br /> magnet; it is wanting to come here and afterward difficult to
				leave it. <br /> Our office is additionally a big name.”
			</>
		),
	},
];
		...
		<>
			<section className='tp-testimonial-2-area p-relative pt-150 pb-120'>
				<div className='tp-testimonial-2-shape'>
					...
					<Image
						className='shape-3'
						src={testimonial_shape_3}
						alt='theme-pure'
					/>
					<Image
						className='shape-4'
						src={testimonial_shape_4}
						alt='theme-pure'
					/>
					<Image
						className='shape-5'
						src={testimonial_shape_5}
						alt='theme-pure'
					/>
				</div>
					...
					<div className='row justify-content-center'>
						<div className='col-lg-8'>
							...
							<div className='tp-testimonial-2-nav d-none d-lg-block'>
								<button
									type='button'
									className='testimonial-button-prev-1'>
									<span>
										<LeftArrowBtn />
									</span>
								</button>
								<button
									type='button'
									className='testimonial-button-next-1'>
									<span>
										<RightArrowBtn />
									</span>
								</button>
